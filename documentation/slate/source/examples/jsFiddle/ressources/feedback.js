    ...
    $('body').append('\
        <div class="jsfiddle">\
            <div class="flex-item icon-wrapper">\
                <img src="https://raw.githubusercontent.com/ballouche/navitia/JSFiddle-feedback-buttons/documentation/slate/source/examples/jsFiddle/ressources/picto.png" alt="logo navitia.io" />\
            </div>\
